...
public class ReportParamByDate extends ExtendedParam {

    public ReportParamByDate() {
    }

    public ReportParamByDate(List<UUID> accounts, LocalDateTime from, LocalDateTime to, List<UUID> categories) {
    ...
    public static class Builder {
        ...
        public ReportParamByDate build() {
            return new ReportParamByDate(accounts, from, to, categories);
        }
    }
}
